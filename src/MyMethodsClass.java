...
public class MyMethodsClass {
	...
	public void Case2() throws Exception{
		...
		try {
			...
			//now check if key exists? if it exists then increment it by 1, else throw error
	...
	public void Case3Discard() throws Exception {
		...
		Transaction transaction = connectToDatabase.multi();
		incrMultiTransaction(connectToDatabase, transaction);
		setInMultiTransaction(connectToDatabase, transaction); //according to problem statement give SET key1 value1 as i/p to set command
		transaction.discard();
